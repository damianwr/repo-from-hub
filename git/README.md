...
В учебных целях у нас есть репозиторий этой статьи на GitHub и мы хотим исправить опечатку, которую нашли в статье. Например, вот эту опечатку.
...
[какое то не полное описание статьи... плохо!]

ну и ещё добавлю одну строчку!
